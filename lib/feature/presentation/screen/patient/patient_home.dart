...
import 'package:apotik_online/feature/presentation/screen/patient/cart_items_list.dart';
import 'package:apotik_online/feature/presentation/screen/patient/drugs_list.dart';
import 'package:apotik_online/feature/presentation/screen/patient/orders_list.dart';
...
class Patient extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _PatientState();
}
...
class _PatientState extends ConsumerState<Patient> {
  ...
  Widget build(BuildContext context) {
    ...
    final patientIndex = ref.watch(patientRiverpod);
    ...
    return Scaffold(
      ...
      body: IndexedStack(
        index: patientIndex,
        children: const [DrugsList(), CartItemsList(), OrdersList()],
      ),
    );
  }
    ...
    return Drawer(
      ...
      child: Column(
        children: [
          ...
          listTile(
            onTap: () {
              ref.read(patientRiverpod.notifier).state = 0;
          ...
          listTile(
            onTap: () {
              ref.read(patientRiverpod.notifier).state = 1;
              scaffoldKey.currentState?.closeDrawer();
            },
            leading: Icons.shopping_cart,
            title: 'List of Cart Items',
            color: white,
            settings: false,
          ),
          listTile(
            onTap: () {
              ref.read(patientRiverpod.notifier).state = 2;
              scaffoldKey.currentState?.closeDrawer();
            },
